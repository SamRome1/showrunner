...
const LINES: TerminalLine[] = [
  ...
  { text: 'This project requires a brief. Fill this in:', at: 56, kind: 'accent' },
  ...HEADERS.map((h, i) => ({ text: h, at: 110 + i * 34, kind: 'output' as const, typed: true, glyph: 'check' as const })),
];
...
export const TheGate: React.FC = () => (
  <SceneWrapper justify="center" halo>
    <Terminal lines={LINES} height={520} title="claude" titleIcon="assets/anthropic.svg" caretUntil={56} active={0.7} />
  </SceneWrapper>
);
